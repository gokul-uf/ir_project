...
class SearchEngineTFIDF {
  ...
  val outputFile  : String = "outputZY.txt"
...
object SearchEngineTFIDF {
  def main(args: Array[String]): Unit = {

    val obj: SearchEngineTFIDF = new SearchEngineTFIDF()
  ...
  def ScoreModeler(obj: SearchEngineTFIDF): MHashMap[String, Double] = {
    ...
    //println("Debug: ScoreModeler: docToQueryTermMap:")
  ...
  def LanguageModeler(obj: SearchEngineTFIDF): MHashMap[String, Double] = {
  ...
  def UniGramLanguageModeler(obj: SearchEngineTFIDF): MHashMap[String, Double] = {
  ...
  def BiGramLanguageModeler(obj: SearchEngineTFIDF): MHashMap[String, Double] = {
  ...
  def QueryInvIndex(obj: SearchEngineTFIDF): MHashMap[String, ListBuffer[(String, Int)]] = {
  ...
  def tipsterParse(obj: SearchEngineTFIDF): ListBuffer[DocToTokensMap] = {
  ...
  def tipsterParseTest(obj: SearchEngineTFIDF): ListBuffer[DocToTokensMap] = {
    var docTokens: ListBuffer[DocToTokensMap] = ListBuffer.empty[DocToTokensMap]
    ...
    obj.queries(0) = "profit narrows".split(" ").map { x => PorterStemmer.stem(x) }
    obj.queries(1) = "narrows loss".split(" ").map { x => PorterStemmer.stem(x) }
  ...
  def createDocToTokensMap(doc: Document): DocToTokensMap = {
    ...
    def wordsWithoutSW: Seq[String] = StopWords.filterOutSW(words) // .take(15000)
