...
object SearchEngineX {
  def main(args: Array[String]): Unit = {

    val obj: SearchEngine = new SearchEngine()
    obj.readQueriesFromFile()

    val docTokens: ListBuffer[DocToTokensMap] = tipsterParseTest(obj)
  ...
  def tipsterParse(obj: SearchEngine): ListBuffer[DocToTokensMap] = {
    val path: String = "/home/ankit/Desktop/Eth/FirstSemester/IR/Project2/Docs/zip"
